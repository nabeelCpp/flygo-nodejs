  ...
  app.group('/api/admin', (router) => {
    ...
    router.group('/agents', (agentsRouter) => {
      ...
      agentsRouter.group('/documents', (agentDocsRouter) => {
        ...
        // Remove document
        agentDocsRouter.delete('/:agent_id/:document_id', adminController.agentDocuments.remove);
    ...
    router.group('/users', (usersRouter) => {
      ...
      usersRouter.patch('/:id', validations.admin.users.userUpdate, adminController.users.update);
      ...
      // Create new user
      usersRouter.post('/users', validations.admin.users.userCreate, adminController.users.store);
